...
const {GetallAppointments,GetExistingAppointmentOfPatient, GetSpecificAppointment, addNewAppointment, DeleteSpecificAppointment, getAvailableAppointments, getFreeTimesForAppointments, updateAppointmentStatus, getTodaysAndFutureAppointments } = require("../controllers/appointmentController");
