...
const addNewAppointment = async (req, res) => {
    try {
        ...
        res.status(201).json({ message: "Appointment Created successfully!", new_appointment });
...
const DeleteSpecificAppointment = async (req, res) => {
    try {
        ...
        res.status(200).json({message:"Appointment Has Been Deleted Successfully!",exist_appointment});
